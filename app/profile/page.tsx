...
import { MapPin, Mail,LogOut, Phone, Droplets, Edit2, Check, X, Loader2 } from "lucide-react"
...
import { ToastAction } from "@/components/ui/toast" // Ensure this module exists or remove if not needed
...
export default function Profile() {
  ...
  const [originalData, setOriginalData] = useState<{ name: string; email: string; phonenumber: string; bloodgroup: string; city: string }>({ name: "", email: "", phonenumber: "", bloodgroup: "", city: "" })
  ...
  return (
    ...
    <div className="min-h-screen w-full text-white">
        ...
        <Button
              variant="outline"
              className="border-red-500/5  bg-red-500/10 text-red-400 hover:bg-red-300 transition-all duration-300 group z-10"
              onClick={logout}
            >
            ...
            <div className="h-32 bg-gradient-to-r from-green-900/40 to-emerald-800/40 relative">
              <div className="absolute -bottom-16 left-8">
                <Avatar className="h-32 w-32 border-4 border-gray-800 shadow-lg">
                  ...
                  <AvatarFallback className="bg-green-700 text-white text-2xl">{name}</AvatarFallback>
                </Avatar>
              </div>
            ...
            <CardContent className="pt-20 pb-8 px-8">
              <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-1">
                      {editProfile ? (
                        <Input
                          ...
                          className="bg-gray-700/60 border-gray-600 text-white text-2xl font-bold h-auto py-1 px-2"
                        />
                      ) : (
                        name
                      )}
                    ...
                    <div className="flex items-center gap-2 text-green-400">
                      ...
                      {editProfile ? (
                        <Input
                          ...
                          className="bg-gray-700/60 border-gray-600 text-green-400 h-7 py-1 px-2"
                        />
                      ) : (
                        <span>{city}</span>
                      )}
                ...
                {isDonor ? (
                    ...
                    className="bg-gray-700/20 rounded-xl p-6 backdrop-blur-sm border border-gray-700/50"
                  >
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="pt-4">
                          <Button className="w-full bg-green-700 hover:bg-green-600 text-white">Schedule Donation</Button>
                        </div>
                      </div>
                    </div>
                  </motion.div>
